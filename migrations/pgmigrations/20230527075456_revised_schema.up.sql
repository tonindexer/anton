...
CREATE TABLE messages (
    ...
    CONSTRAINT messages_tx_lt_notnull CHECK ((((src_address IS NOT NULL) AND (src_tx_lt IS NOT NULL) AND (dst_address IS NULL) AND (dst_tx_lt IS NULL)) OR ((src_address IS NULL) AND (src_tx_lt IS NULL) AND (dst_address IS NOT NULL) AND (dst_tx_lt IS NOT NULL)) OR ((src_address IS NOT NULL) AND (src_tx_lt IS NOT NULL) AND (dst_address IS NOT NULL) AND (dst_tx_lt IS NOT NULL))))
);
